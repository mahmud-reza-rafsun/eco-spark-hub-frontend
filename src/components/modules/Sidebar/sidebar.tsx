...
const Sidebar = ({
    ...
    return (
        <aside
            ...
            bg-white dark:bg-[#09090b] z-40
            ${isCollapsed ? "w-20" : "w-64"}`}
        >
            <button
                onClick={() => setIsCollapsed((prev) => !prev)}
                className="absolute -right-3.5 cursor-pointer top-2.5 z-50 p-1 rounded-full bg-white dark:bg-[#161313] border border-gray-200 dark:border-gray-500 text-gray-500 hover:text-indigo-500 shadow-sm transition-all"
            >
                {isCollapsed ? (
