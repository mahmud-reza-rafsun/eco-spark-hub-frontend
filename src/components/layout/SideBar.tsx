    ...
    return (
        <aside
            ...
            <button
                ...
                className="absolute cursor-pointer -right-3.5 top-2.5 z-50 p-1 rounded-full bg-white dark:bg-[#161313] border border-gray-200 dark:border-gray-500 text-gray-500 hover:text-indigo-500 shadow-sm transition-all"
            >
                        ...
                        return (
                            <Link
                                ...
                                className={`flex items-center rounded-xl transition-all duration-200 group relative
                                        ${isSidebarCollapsed ? 'justify-center px-0 py-3' : 'px-4 py-3 gap-4'}
                                        ${isActive
