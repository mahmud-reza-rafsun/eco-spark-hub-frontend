        ...
        <div>
            ...
            <section className="relative z-10 pt-24 pb-28 md:pt-36 md:pb-40 px-5 sm:px-8">
                <div className="container mx-auto flex flex-col items-center text-center">
                    {/* Badge */}
                    <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full border border-indigo-500/30 bg-indigo-500/10 text-xs font-medium text-indigo-300 tracking-wide mb-7">
                        <span className="w-1.5 h-1.5 rounded-full bg-indigo-400 animate-pulse" />
                        Open to everyone — share, discover, build
                    </div>

                    {/* Heading */}
                    <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-[68px] font-extrabold text-white tracking-tight leading-[1.1] max-w-4xl">
                        Where Ideas Meet{" "}
                        <span className="bg-gradient-to-br from-indigo-400 via-indigo-300 to-indigo-100 bg-clip-text text-transparent">
                            Real Problems
                        </span>
                    </h1>
