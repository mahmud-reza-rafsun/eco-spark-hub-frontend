...
import { insightCategoryPostAction } from "./InsightCategoryPostAction";

export default function InsightCategoryPostForm() {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            const result = await insightCategoryPostAction(formData);
